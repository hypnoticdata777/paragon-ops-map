...
function toggleDepartment(deptId) {
  ...
  depts.forEach(dept => {
    ...
    if (header.textContent.includes(deptId) || header.onclick.toString().includes(deptId)) {
    ...
    <div class="model-card">
      ...
      <div style="margin-top: 15px; display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
        ...
        <div style="background: #fef2f2; padding: 15px; border-radius: 8px; border-left: 3px solid #d32f2f;">
          <h5 style="margin-bottom: 8px; color: #d32f2f;">⚠️ Cons</h5>
          <ul style="font-size: 13px;">
...
function renderCaseStudies() {
  ...
  container.innerHTML = caseStudies.map(study => `
    <div class="case-study">
      ...
      <p style="margin-top: 15px;"><a href="${study.link}" target="_blank" style="color: #1976d2; font-weight: 600;">Read Full Case Study →</a></p>
    </div>
  `).join('');
}
