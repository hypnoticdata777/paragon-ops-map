...
const orgData = {
  ...
  departments: [
    ...
    },
    {
      ...
      color: "#c62828",
      tasks: [
        { name: "Review daily delinquencies", owner: "Linda" },
        { name: "Send automated payment reminders", owner: "Carlos" },
        { name: "Set up and track payment plans", owner: "Linda" },
        { name: "Generate and send 5-day notices", owner: "Linda" },
        { name: "Coordinate with process servers", owner: "Jason" },
        { name: "Coordinate posting with Field Tech", owner: "Kevin" },
        { name: "Handle eviction filing (admin)", owner: "Jason" },
        { name: "Manage court scheduling (admin)", owner: "Jason" },
        { name: "Perform ledger cleanup & accuracy checks", owner: "Austin" },
        { name: "Track NSF (non-sufficient funds)", owner: "Austin" },
        { name: "Negotiate early move-outs", owner: "Nathan" },
        { name: "Issue lease violation notices", owner: "Linda" },
        { name: "Handle smoking violations", owner: "Linda" },
        { name: "Address unauthorized occupants/pets", owner: "Linda" },
        { name: "Prevent utility shutoff situations", owner: "Linda" },
        { name: "Process garnishments or court-ordered payments", owner: "Austin" }
      ]
    },
    {
      id: "maintenance",
